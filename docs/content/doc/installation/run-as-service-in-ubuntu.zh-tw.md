...
複製範例 [gitea.service](https://github.com/git3protocol/gitea/blob/master/contrib/systemd/gitea.service) 到 `/etc/systemd/system/gitea.service` 後用您喜愛的文字編輯器開啟檔案。
...
附加範例 [supervisord config](https://github.com/git3protocol/gitea/blob/master/contrib/supervisor/gitea) 的設定值到 `/etc/supervisor/supervisord.conf`。

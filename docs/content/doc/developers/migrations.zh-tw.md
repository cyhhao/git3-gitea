...
Gitea 定義了一些基本物件於套件 [modules/migration](https://github.com/git3protocol/gitea/tree/master/modules/migration)。
...
您可以在 [downloader.go](https://github.com/git3protocol/gitea/blob/master/modules/migration/downloader.go) 中找到這些介面。
...
您可以在 [uploader.go](https://github.com/git3protocol/gitea/blob/master/modules/migration/uploader.go) 中找到這些介面。

...
First of all, Gitea defines some standard objects in packages [modules/migration](https://github.com/git3protocol/gitea/tree/main/modules/migration).
...
You can find these interfaces in [downloader.go](https://github.com/git3protocol/gitea/blob/main/modules/migration/downloader.go).
...
You can find these interfaces in [uploader.go](https://github.com/git3protocol/gitea/blob/main/modules/migration/uploader.go).
